...
$select_eisurvey_sql = "SELECT * FROM eisurvey WHERE belong_to = '$program_id'";
$retval = mysql_query( $select_eisurvey_sql, $conn );
...
if( $_SERVER["REQUEST_METHOD"] == "POST" ) {
  ...
  if ( $num_of_rows == 1 ) {
    ...
    $update_eisurvey_sql = "UPDATE eisurvey SET
    ...
    totalvendorsincounty = $totalVendorinCounty,
    totalexpensesincounty = $totalExpenseinCounty,
    totalvendorsoutofcounty = $totalVendoroutofCounty,
    totalexpensesoutofcounty = $totalExpenseoutofCounty

    WHERE belong_to = '$program_id'";
    $retval = mysql_query( $update_eisurvey_sql, $conn );
